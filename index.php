...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/pengadang.png" width="50" height="80" alt="logo"></a>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> KANTOR DESA</h2>
    ...
    <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/place/Kantor+Desa+Pengadang/@-8.6898914,116.3194152,15z/data=!4m13!1m7!3m6!1s0x2dcdb3d4dec9dd43:0x5030bfbcaf7d9b0!2sPengadang,+Praya+Tengah,+Kabupaten+Lombok+Tengah,+Nusa+Tenggara+Bar.!3b1!8m2!3d-8.6884064!4d116.3278958!3m4!1s0x2dcdb3d6eee0d2db:0x9a4ffd40e46ce635!8m2!3d-8.6841155!4d116.3289013" width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi kelurahan"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> Your Company. Credit by <a target="_blank" href="https://www.instagram.com/rizal_m1309/" title="Ikuti saya">Rizal Mahendra</a>
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="https://www.instagram.com/rizal_m1309/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="https://www.facebook.com/profile.php?" target="_blank"><i class="fa fa-facebook"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
